...
Menu.AddMenuIcon({"Hero Specific", "SkyWrathMage"}, "~/panorama/images/heroes/icons/npc_dota_hero_skywrath_mage_png.png")
Menu.AddOptionIcon(SkyWrathMage.IsToggled, "~/npc_dota_hero_unnamed_png.png")	
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

SkyWrathMage.IsTargetParticleEnabled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Target indicator", false)
Menu.AddOptionIcon(SkyWrathMage.IsTargetParticleEnabled , "panorama/images/spellicons/skywrath_mage_concussive_shot_png.vtex_c")
SkyWrathMage.IsConcShotParticleEnabled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Concussive shot indicator", false)
Menu.AddOptionIcon(SkyWrathMage.IsConcShotParticleEnabled , "panorama/images/spellicons/skywrath_mage_concussive_shot_png.vtex_c")
SkyWrathMage.enemyInRange = Menu.AddOptionSlider({"Hero Specific", "SkyWrathMage"}, "Closest to mouse range", 100, 600, 100)
SkyWrathMage.combokey = Menu.AddKeyOption({"Hero Specific", "SkyWrathMage"}, "Combo Key", Enum.ButtonCode.KEY_D)
Menu.AddOptionIcon(SkyWrathMage.combokey , "panorama/images/icon_treasure_arrow_psd.vtex_c")
SkyWrathMage.harraskey = Menu.AddKeyOption({"Hero Specific", "SkyWrathMage"}, "Harras Key", Enum.ButtonCode.KEY_F)
Menu.AddOptionIcon(SkyWrathMage.harraskey , "panorama/images/icon_treasure_arrow_psd.vtex_c")
...
Menu.AddMenuIcon({"Hero Specific", "SkyWrathMage", "Abilities"}, "panorama/images/icon_plus_white_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.AbilitiesOptionID["silence"] , "panorama/images/spellicons/skywrath_mage_ancient_seal_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.AbilitiesOptionID["bolt"] , "panorama/images/spellicons/skywrath_mage_arcane_bolt_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.AbilitiesOptionID["slow"] , "panorama/images/spellicons/skywrath_mage_concussive_shot_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.AbilitiesOptionID["ulti"] , "panorama/images/spellicons/skywrath_mage_mystic_flare_alt_png.vtex_c")

---------harras-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

SkyWrathMage.menuAbilities2 = {bolt = "Arcane Bolt", slow = "Concussive Shot", silence = "Ancient Seal"}
SkyWrathMage.AbilitiesOptionID2 = {bolt,slow,silence}
for k, v in pairs(SkyWrathMage.menuAbilities2) do
	SkyWrathMage.AbilitiesOptionID2[k] = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage", "Harras Abilities"}, SkyWrathMage.menuAbilities2[k], false)
end
Menu.AddMenuIcon({"Hero Specific", "SkyWrathMage", "Harras Abilities"}, "panorama/images/icon_plus_white_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.AbilitiesOptionID2["silence"] , "panorama/images/spellicons/skywrath_mage_ancient_seal_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.AbilitiesOptionID2["bolt"] , "panorama/images/spellicons/skywrath_mage_arcane_bolt_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.AbilitiesOptionID2["slow"] , "panorama/images/spellicons/skywrath_mage_concussive_shot_png.vtex_c")
...
Menu.AddMenuIcon({"Hero Specific", "SkyWrathMage", "Magic Damage Items"}, "panorama/images/icon_plus_white_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.ItemsOptionID["dagon"] , "panorama/images/items/dagon_5_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.ItemsOptionID["hex"] , "panorama/images/items/sheepstick_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.ItemsOptionID["eblade"] , "panorama/images/items/ethereal_blade_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.ItemsOptionID["atos"] , "panorama/images/items/rod_of_atos_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.ItemsOptionID["nullifier"] , "panorama/images/items/nullifier_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.ItemsOptionID["veil"] , "panorama/images/items/nullifier_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.ItemsOptionID["shiva"] , "panorama/images/items/shivas_guard_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.ItemsOptionID["veil"] , "panorama/images/items/veil_of_discord_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.ItemsOptionID["blood"] , "panorama/images/items/bloodthorn_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.ItemsOptionID["orchid"] , "panorama/images/items/orchid_png.vtex_c")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Menu.AddMenuIcon({"Hero Specific", "SkyWrathMage", "Pop Linkens Items"}, "panorama/images/items/sphere_png.vtex_c")
...
SkyWrathMage.PopLinkensOptionID = {nullifier, cyclone, atos, hex, forcestaff, dagon, orchid, bloodthorn, silence, bolt, hurricane}
...
Menu.AddMenuIcon({"Hero Specific", "SkyWrathMage", "Pop Linkens Items"}, "panorama/images/icon_plus_white_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.IsPopLinkenToggled , "panorama/images/items/branches_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopLinkensOptionID["nullifier"] , "panorama/images/items/nullifier_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopLinkensOptionID["cyclone"] , "panorama/images/items/cyclone_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopLinkensOptionID["atos"] , "panorama/images/items/rod_of_atos_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopLinkensOptionID["hex"] , "panorama/images/items/sheepstick_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopLinkensOptionID["forcestaff"] , "panorama/images/items/force_staff_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopLinkensOptionID["dagon"] , "panorama/images/items/dagon_5_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopLinkensOptionID["orchid"] , "panorama/images/items/orchid_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopLinkensOptionID["bloodthorn"] , "panorama/images/items/bloodthorn_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopLinkensOptionID["silence"] , "panorama/images/spellicons/skywrath_mage_ancient_seal_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopLinkensOptionID["bolt"] , "panorama/images/spellicons/skywrath_mage_arcane_bolt_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopLinkensOptionID["hurricane"] , "panorama/images/items/hurricane_pike_png.vtex_c")
...
SkyWrathMage.PopupAMReflectOptionID = {nullifier, cyclone, atos, hex, forcestaff, dagon, orchid, bloodthorn, silence, bolt, hurricane}
...
Menu.AddMenuIcon({"Hero Specific", "SkyWrathMage", "Pop Antimage's Reflect Items"}, "panorama/images/icon_plus_white_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.IsPopAMReflectToggled , "panorama/images/items/branches_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopupAMReflectOptionID["atos"] , "panorama/images/items/rod_of_atos_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopupAMReflectOptionID["forcestaff"] , "panorama/images/items/force_staff_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopupAMReflectOptionID["dagon"] , "panorama/images/items/dagon_5_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopupAMReflectOptionID["cyclone"] , "panorama/images/items/cyclone_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopupAMReflectOptionID["nullifier"] , "panorama/images/items/nullifier_png.vtex_c")
Menu.AddOptionIcon(SkyWrathMage.PopupAMReflectOptionID["bolt"] , "panorama/images/spellicons/skywrath_mage_arcane_bolt_png.vtex_c")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

SkyWrathMage.IsBMToggled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Check for BladeMail", false)
Menu.AddOptionIcon(SkyWrathMage.IsBMToggled, "panorama/images/items/blade_mail_png.vtex_c")
SkyWrathMage.IsSRToggled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Use Soul Ring", false)
Menu.AddOptionIcon(SkyWrathMage.IsSRToggled, "panorama/images/items/soul_ring_png.vtex_c")
SkyWrathMage.IsBlinkToggled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Use Blink Dagger", false)
Menu.AddOptionIcon(SkyWrathMage.IsBlinkToggled, "panorama/images/items/blink_png.vtex_c")
SkyWrathMage.IsDoubleUltiToggled = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Double ulti mode", false)
Menu.AddOptionIcon(SkyWrathMage.IsDoubleUltiToggled, "panorama/images/spellicons/skywrath_mage_mystic_flare_alt_png.vtex_c")
SkyWrathMage.IsEZKChecked = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage"}, "Check for EZ Kill", false)
Menu.AddOptionIcon(SkyWrathMage.IsEZKChecked, "panorama/images/icon_locked_png.vtex_c")
SkyWrathMage.EZTogglerKey = Menu.AddKeyOption({"Hero Specific", "SkyWrathMage"}, "EZ Kill Toggle Key", Enum.ButtonCode.KEY_V)
Menu.AddOptionIcon(SkyWrathMage.EZTogglerKey , "panorama/images/icon_treasure_arrow_psd.vtex_c")
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

SkyWrathMage.IsEZKCheckedDraw = Menu.AddOptionBool({"Hero Specific", "SkyWrathMage","Settings Draw"}, "Close EZ Kill Draw", false)
SkyWrathMage.Arriba = Menu.AddOptionSlider({"Hero Specific", "SkyWrathMage","Settings Draw" }, "Right and Left", 0, 1920, 950)
SkyWrathMage.Derecha = Menu.AddOptionSlider({"Hero Specific", "SkyWrathMage","Settings Draw" }, "Down and Up", 0, 1080, 750)

Menu.AddMenuIcon({"Hero Specific", "SkyWrathMage","Settings Draw"}, "panorama/images/icon_plus_white_png.vtex_c")
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function SkyWrathMage.OnUpdate()
	...
	SkyWrathMage.Longarriba = Menu.GetValue(SkyWrathMage.Arriba)
	SkyWrathMage.Longderecha = Menu.GetValue(SkyWrathMage.Derecha)
...
function SkyWrathMage.OnDraw()
	...
	x = SkyWrathMage.Longarriba
	y = SkyWrathMage.Longderecha
	if not Menu.IsEnabled(SkyWrathMage.IsEZKCheckedDraw) then return end
	if Menu.IsEnabled(SkyWrathMage.IsEZKChecked) then
...
function SkyWrathMage.ArcaneHarras()
	...
	SkyWrathMage.GetAbilities()		
	if SkyWrathMage.CastAbility(bolt, SkyWrathMage.AbilitiesOptionID2["bolt"]) then return end
	if SkyWrathMage.CastAbility(slow, SkyWrathMage.AbilitiesOptionID2["slow"]) then return end
	if SkyWrathMage.CastAbility(silence, SkyWrathMage.AbilitiesOptionID2["silence"]) then return end
end
...
function SkyWrathMage.GetAbilities2()
...
function SkyWrathMage.IsEZKillableCheck()
	...
	if bolt and Ability.IsReady(bolt) and Menu.IsEnabled(SkyWrathMage.AbilitiesOptionID2["bolt"]) then
		local boldamage = Ability.GetLevelSpecialValueFor(bolt, "bolt_damage") + Hero.GetIntellectTotal(myHero) * 1.6
		if Ability.GetLevel(bolt) < 3 then
			totalDamage = totalDamage + (1 - NPC.GetMagicalArmorValue(enemy)) * (1 + silenceAmp) * (1 + veilAmp) * (1 + ebladeAmp) * (1 + modifamplifiers) * (boldamage + boldamage * perkAmp)
			reqMana = reqMana + Ability.GetManaCost(bolt)                    
	...
	if slow and Ability.IsReady(slow) and Menu.IsEnabled(SkyWrathMage.AbilitiesOptionID2["slow"]) then
	...
	if silence and Ability.IsReady(silence) and Menu.IsEnabled(SkyWrathMage.AbilitiesOptionID2["silence"]) then
		silenceAmp = silenceAmp + (Ability.GetLevel(silence) * 5 + 30) / 100
		reqMana = reqMana + Ability.GetManaCost(silence)
	end
