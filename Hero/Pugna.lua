...
PugnaD.optionEnable = Menu.AddOptionBool({"Hero Specific","Pugna"},"Enabled","")
PugnaD.optionKey = Menu.AddKeyOption({"Hero Specific","Pugna"},"Combo Key",Enum.ButtonCode.KEY_SPACE)
PugnaD.optionEnableVeil = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Veil Of Discord","")
PugnaD.optionEnableHex = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Scythe Of Vyse","")
PugnaD.optionEnableBloth = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Bloodthorn","")
PugnaD.optionEnableEblade = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Ethereal Blade","")
PugnaD.optionEnableOrchid = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Orchid Malevolence","")
PugnaD.optionEnableRefresher = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Refresher Orb","")
PugnaD.optionEnableBlink = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Blink","")
PugnaD.optionEnableShadow = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Shadow Blade","")
PugnaD.optionEnableSilver = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Silver Edge","")
PugnaD.optionEnableGlimmer = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Glimmer Cape","")
PugnaD.optionEnableRoA = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Rod Of Atos","")
PugnaD.optionEnableSring = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Soul Ring","")
PugnaD.optionEnableSguard = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Shivas Guard","")
PugnaD.optionEnableDagon = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Items"},"Use Dagon","")
PugnaD.optionEnableNetherBlast = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Abilities"},"Use NetherBlast","")
PugnaD.optionEnableDecrepify = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Abilities"},"Use Decrepify","")
PugnaD.optionEnableNWard = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Abilities"},"Use NWard","")
PugnaD.optionEnableLifedrain = Menu.AddOptionBool({ "Hero Specific","Pugna","Toggle Abilities"},"Use Lifedrain","")
PugnaD.optionEnableLinkens1 = Menu.AddOptionBool({ "Hero Specific","Pugna","Linkens Breaker"},"Break With Lifedrain","")
PugnaD.optionEnableLinkens2 = Menu.AddOptionBool({ "Hero Specific","Pugna","Linkens Breaker"},"Break With Decrepify","")
PugnaD.optionEnableLinkens3 = Menu.AddOptionBool({ "Hero Specific","Pugna","Linkens Breaker"},"Break With Force Staff","")
PugnaD.optionEnableLinkens4 = Menu.AddOptionBool({ "Hero Specific","Pugna","Linkens Breaker"},"Break With Hurricane Pike","")
PugnaD.optionEnableLinkens5 = Menu.AddOptionBool({ "Hero Specific","Pugna","Linkens Breaker"},"Break With EUL","")
PugnaD.optionEnableBmail = Menu.AddOptionBool({"Hero Specific","Pugna"},"Stop Combo When Blademail Activated","")
PugnaD.optionEnableLorb = Menu.AddOptionBool({"Hero Specific","Pugna"},"Stop Combo When Lotus Orb Activated","")
...
function PugnaD.OnUpdate()
  ...
  --end
	...
	if not NPC.IsLinkensProtected(hero) and Menu.IsEnabled(PugnaD.optionEnableLifedrain) and enemy and Lifedrain and Ability.IsReady(Lifedrain) and Ability.IsCastable(Lifedrain, myMana) then Ability.CastTarget(Lifedrain, enemy) end
    
	if not NPC.IsLinkensProtected(hero) and Menu.IsEnabled(PugnaD.optionEnableRefresher) and refresh and Ability.IsCastable(refresh, myMana) then Ability.CastNoTarget(refresh); return end
	end
